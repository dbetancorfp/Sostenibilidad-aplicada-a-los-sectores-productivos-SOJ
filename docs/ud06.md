...
9. [De dónde sale esto (fuentes de la carpeta)](#de-donde-sale-esto-fuentes-de-la-carpeta)
...
- `u6_SOJ.pdf` — Documento base de la unidad (Departamento de informática). Aporta la definición y clasificación de grupos de interés, los criterios ASG, las acciones de minimización y los horizontes 2030/2050 de la UE, los tipos de KPI, los índices de sostenibilidad (DJSI, MSCI, FTSE4Good), la estructura y objetivos del informe de sostenibilidad, la definición de plan de sostenibilidad y sus nueve pasos, el ejemplo aplicado al grupo de clase, el glosario y la metáfora del cuadro de mandos del barco.
- `UNIDAD_6.pdf` — Presentación "Informes y certificaciones de sostenibilidad para empresas" (Ediciones Paraninfo). Aporta el detalle del EINF y la Ley 11/2018 (umbrales, contenidos, estructura en 5 puntos, firma, presentación y verificación desde 2025), los estándares GRI y el cuadro CII-FESG de la AECA, las etiquetas ecológicas (tipos I, semitipo I y II), los sistemas de certificación y sus fases, la ISO 14001 y el ciclo PHVA, el reglamento EMAS, los sistemas FSC y PEFC, la jerarquía de la legislación ambiental, la relación de normativa estatal relevante y la normativa de evaluación ambiental (Ley 21/2013, Ley 9/2018, RD 445/2023) con el circuito DIA/IIA.
