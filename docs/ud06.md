...
Esta unidad aborda cómo una organización documenta y acredita su sostenibilidad. Dos piezas que conviene no confundir: el **plan de sostenibilidad** es la hoja de ruta —a dónde quiere llegar la organización, con qué metas y plazos—, y el **informe de sostenibilidad** es la rendición de cuentas —qué se ha conseguido durante el año, con datos—. Alrededor de ambos aparecen los **grupos de interés**, el **análisis de materialidad**, los **KPI** o indicadores, las **etiquetas ecológicas** y **certificaciones** (ISO 14001, EMAS, FSC/PEFC) y la **legislación ambiental** que fija el mínimo obligatorio.

El enfoque es el de *analista*: tomar el plan de sostenibilidad de una empresa real, identificar sus grupos de interés, determinar qué aspectos ambientales, sociales y de gobernanza (ASG) son relevantes y valorar si las acciones y los indicadores propuestos permiten medir el progreso. Una imagen útil: un plan de sostenibilidad es como el cuadro de mandos de un barco transatlántico, que no solo vigila velocidad y combustible (lo económico), sino también el estado del motor (gobernanza), el bienestar de la tripulación y el pasaje (lo social) y que no se viertan residuos al océano (lo ambiental).
...
*Figura: clasificación de los grupos de interés (internos/externos) con sus expectativas, y los tres bloques de criterios ASG.*
...
- Los aspectos ASG materiales se convierten en objetivos de negocio (ejemplo: Iberdrola y su meta Net Zero para 2040).
...
Ejemplos de acciones ya implantadas por empresas:
...
El patrón es claro: cada acción ataca un aspecto ASG material concreto (energía, residuos, emisiones) y es **medible**. Una acción que no se puede medir no sirve para un plan de sostenibilidad, porque no habrá forma de saber si ha funcionado. Por eso las acciones van siempre emparejadas con **métricas**: cada objetivo lleva su indicador, su valor de partida, su meta y su fecha.
...
- Ejemplos: energía renovable y fin de plásticos de un solo uso (Inditex), descarbonización y movilidad sostenible (Iberdrola), autoconsumo solar y biomasa (Nestlé).
...
Un ejemplo sencillo de KPI: **"el consumo total de energía, medido en kWh"**. Es un buen indicador porque es objetivo, fácil de recoger y se puede comparar con años anteriores y con otras empresas.

Para que los KPI de distintas empresas se puedan comparar, existen **estándares** que definen cómo se calculan y se presentan. Los más usados por las empresas españolas son:
...
- Ejemplo de KPI: consumo total de energía en kWh.
...
*Figura: condiciones de la Ley 11/2018 para estar obligado a publicar el estado de información no financiera.*
...
*Figura: los cinco apartados obligatorios del EINF (modelo de negocio, políticas, resultados, riesgos e indicadores).*
...
*Figura: secuencia de pasos para elaborar un plan de sostenibilidad. Reconoce el ciclo de mejora continua: diagnosticar, planificar, medir, revisar.*

Un ejercicio ilustrativo consiste en **aplicar estos pasos a una organización pequeña, como un centro educativo**. Un caso de ejemplo detecta problemas como el exceso de residuos plásticos, luces encendidas en salas vacías y poca separación de basuras; propone contenedores de reciclaje, campañas de apagado de luces y envases reutilizables; identifica los intereses de las personas usuarias, la plantilla, la dirección y otros colectivos; fija un objetivo (reducir residuos un 30 % y consumo energético un 20 % en 6 meses, alineado con el ODS 12 y el ODS 7) con metas concretas (recoger 50 kg de reciclaje al mes, dos talleres mensuales sobre ODS); y reparte responsabilidades (coordinación única, turnos rotatorios, integración de los ODS en cada área y aprobación de recursos por la dirección). Es el mismo esquema que usaría una empresa, a menor escala.
...
*Figura: ecoetiquetas que requieren verificación de una entidad certificadora independiente. La "flor" de la UE es tipo I; la Hoja Verde y la RSPO son de semitipo I.*
...
*Figura: ecoetiquetas tipo II o autodeclaraciones ambientales; no requieren verificación externa, las declara el propio fabricante.*

### 6.2. Certificación de la sostenibilidad

Los **sistemas de certificación** evalúan la sostenibilidad de las empresas **sea cual sea su tamaño, tipo o actividad**. Ejemplos habituales: las **normas ISO**, el **reglamento EMAS** y los sistemas de gestión forestal sostenible **FSC** y **PEFC**.
...
*Figura: las tres partes de cualquier sistema de certificación (quien publica el estándar, la empresa y la entidad certificadora) y los cuatro sistemas citados.*
...
*Figura: primeras fases de un proceso de certificación. El paso 1 vuelve a ser el compromiso de la dirección, igual que en el plan de sostenibilidad.*
...
*Figura: la ISO 14001 y el ciclo Planificar-Hacer-Verificar-Actuar, con los diez apartados de la norma repartidos en esas cuatro fases.*
...
*Figura: características del reglamento EMAS. Va un paso más allá de la ISO 14001 al exigir indicadores de eficiencia de recursos e implicación del personal.*
...
*Figura: pirámide de la legislación ambiental. Cada escalón inferior debe respetar los superiores, y todos, la Constitución.*

**Normativa ambiental estatal relevante** (vigente en el momento de elaborarse la bibliografía de referencia). Algunos ejemplos por bloques:
...
*Figura: circuito administrativo de la evaluación ambiental según la Ley 21/2013. DIA = declaración de impacto ambiental; IIA = informe de impacto ambiental.*
