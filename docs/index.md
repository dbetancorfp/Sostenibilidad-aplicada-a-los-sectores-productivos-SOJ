...
7. [Bibliografía y fuentes citadas](#bibliografia-y-fuentes-citadas)
---
...
![Extracto del Informe Brundtland (1987), "Nuestro Futuro Común": el punto 27 define el desarrollo duradero y su idea de límites.](img_resumen/informe-brundtland.png)
...
![A la izquierda, los tres círculos que se solapan (soportable, equitativo, viable); a la derecha, los círculos concéntricos con la economía dentro de la sociedad y esta dentro del medioambiente.](img_resumen/dimensiones-sostenibilidad.png)
...
![Esquema del efecto invernadero: la energía solar entra, parte de la radiación de la superficie es retenida y el balance neto resulta positivo.](img_resumen/efecto-invernadero.jpg)
...
![Ilustración: un grupo diverso de personas sostiene los iconos de los ODS delante del planeta.](img_resumen/ods-toda-la-sociedad.png)
...
![Panel oficial de los 17 Objetivos de Desarrollo Sostenible, cada uno con su número, color e icono.](img_resumen/ods-17-objetivos.png)
*Los 17 Objetivos de Desarrollo Sostenible. Fuente: Tema 2 (Naciones Unidas).*

![La rueda de colores de los ODS.](img_resumen/rueda-ods.png)
...
![Los cinco pasos del SDG Compass con un icono cada uno: entender los ODS, definir prioridades, establecer objetivos, integrar y reportar.](img_resumen/sdg-compass-5-pasos.png)
*Los cinco pasos del SDG Compass. Fuente: Tema 2 (Pacto Mundial / GRI / WBCSD).*

![Diagrama del Modelo Lógico con cinco cajas encadenadas: insumos, actividades, productos, resultados e impactos, con un ejemplo de tabletas potabilizadoras y el ODS 3.](img_resumen/modelo-logico.png)
*El Modelo Lógico: de los insumos a los impactos, para seleccionar indicadores. Fuente: Tema 2.*

![Esquema en cascada: un KPI ligado al ODS 12 se despliega en agendas de función (I+D, cadena de suministro) y estas en metas individuales.](img_resumen/cascada-objetivos-ods.png)
*Cómo un objetivo ODS se despliega por funciones hasta llegar a metas individuales. Fuente: Tema 2.*

![Las tres áreas del marco SDG Ambition: anclar la ambición en la estrategia y la gobernanza, profundizar la integración en las operaciones y reforzar la participación de los grupos de interés.](img_resumen/sdg-ambition.png)
