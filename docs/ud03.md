...
Esta unidad traslada la sostenibilidad al plano concreto del trabajo técnico y de la vida diaria: cómo se aplican los criterios de sostenibilidad al diseñar un sistema, configurar un servidor, mantener una red o tomar una decisión de compra.

La idea central es el **desempeño sostenible**. El desempeño es la forma en que una persona realiza su actividad, profesional o personal. Un **desempeño profesional sostenible** es eficiente, eficaz y ético, atiende al bienestar de las personas y del planeta y contribuye al desarrollo sostenible; un **desempeño personal sostenible** es equilibrado y saludable y tiene en cuenta el efecto de las propias acciones sobre el entorno. Los **Objetivos de Desarrollo Sostenible (ODS)** de la Agenda 2030 sirven de referencia para orientar ese desempeño. El documento identifica los ODS más relevantes para un perfil técnico e informático, analiza los **riesgos y oportunidades** que plantean, propone **acciones concretas** en el ámbito profesional y personal, describe cómo las empresas formalizan esta gestión mediante el marco de los **IRO** (Impactos, Riesgos y Oportunidades), la **doble materialidad** y la normativa europea (CSRD, ESRS, CSDDD), y cierra con la **ética y la responsabilidad digital**.
...
No todos los ODS pesan lo mismo en cada profesión. En el sector de la informática y la tecnología, los **tres ODS más relevantes** suelen ser:
...
Esto no significa que los demás ODS no cuenten. Un servicio digital bien hecho puede contribuir al ODS 4 (educación de calidad), al ODS 3 (salud y bienestar) o al ODS 10 (reducción de las desigualdades) si mejora el acceso a servicios para colectivos vulnerables. La clave es **enlazar cada ODS elegido como importante con una actividad profesional concreta**. Por ejemplo: *"ODS 12: implementar sistemas de reciclaje de hardware en empresas"*. Ese es el nivel de concreción buscado: no basta con "apoyar el ODS 12", hay que indicar *qué acción* lo materializa.
...
*Figura: cómo una gran empresa del sistema productivo ordena su estrategia en las dimensiones Ambiental, Social y Gobernanza (ASG) y añade unos "aceleradores de crecimiento" (ciberseguridad, digitalización y finanzas sostenibles). Enlaza su actividad directamente con ODS concretos: 7 (energía asequible y no contaminante), 9 (industria, innovación e infraestructura), 11 (ciudades sostenibles) y 13 (acción por el clima).*
...
Cuando se combinan las dos, se habla de **doble materialidad**. Una regla práctica: **la mayoría de los impactos materiales acaban convirtiéndose en riesgos u oportunidades financieras**. Por ejemplo:
...
Pero también hay riesgos u oportunidades **sin impacto previo**, que surgen de **dependencias externas**. Por ejemplo, la **escasez de agua** en una región es un riesgo para la empresa **aunque ella no sea la causante principal** de esa escasez, porque depende de ese recurso.
...
Un desempeño **profesional** sostenible:
...
**Ventajas** de tener un plan y una cultura de sostenibilidad:
...
Tres líneas claras para un entorno técnico:
...
Otras acciones cotidianas: usar **transporte público** o **reducir el consumo energético en casa**. La educación ambiental funciona: distintos estudios indican que hasta el **83 % de los niños y niñas** que reciben clases de educación ambiental **mejoran su comportamiento ecológico**.

### 4.3. Acciones para atender retos ambientales y sociales concretos

Estas acciones conectan con los grandes retos ambientales y sociales. Algunos datos para dimensionar el problema:
...
*Figura: ejemplo de acciones profesionales medibles en el terreno digital. La empresa fija objetivos concretos de **ciberejercicios** (simulacros de incidente de ciberseguridad para entrenar la respuesta), de **verificación de la seguridad de las TIC** y de **inversión en digitalización**, y los enlaza con los ODS 4, 7, 9, 11 y 13.*
...
- La educación ambiental **cambia comportamientos** (hasta un 83 % de mejora en el comportamiento ecológico infantil).

---

## 5. Ética y responsabilidad digital

Esta última sección tiene dos caras: la **normativa y los estándares** con los que las organizaciones formalizan su compromiso (y que marcan lo que está bien y lo que no), y la **sostenibilidad personal** entendida como coherencia ética en el día a día. La ética digital "pura" (privacidad, sesgos algorítmicos, uso responsable de la IA) se trata aquí de forma más breve que el marco normativo europeo, que es donde hoy se concentra buena parte de la "responsabilidad" de un perfil técnico.
...
| Norma | Nombre completo | Para qué sirve | Qué obliga a hacer |
| --- | --- | --- | --- |
| **CSRD** | *Corporate Sustainability Reporting Directive* | Directiva de la UE que exige a grandes empresas y cotizadas **informar** de forma estandarizada y detallada sobre sus impactos en sostenibilidad (ASG). | **Informar** sobre los IRO. Solo informar. |
| **ESRS** | *European Sustainability Reporting Standards* (Normas Europeas de Información sobre Sostenibilidad) | Conjunto de estándares de la UE para reportar de forma **estandarizada y comparable** el desempeño ASG, dentro del marco de la CSRD. Definen **qué información, métricas e indicadores** hay que divulgar (clima, biodiversidad, derechos humanos, gobernanza…). | **Clasificar** los IRO dentro de un estándar. Hay **12 ESRS**. |
...
Cómo encajan las piezas, con un ejemplo: se detecta un **riesgo** de trabajo infantil en proveedores de Asia → la **CSRD** obliga a informarlo (es un riesgo material) → se acude a los **ESRS** y se clasifica en el estándar **ESRS S2** (trabajadores en la cadena de valor) → se siguen las instrucciones del ESRS S2 para explicar cómo se ha detectado y qué se hace para eliminarlo, que es la parte de **diligencia debida** (**CSDDD**).
...
*Figura: los **12 ESRS** agrupados en cuatro bloques. Transversales: ESRS 1 (requisitos generales) y ESRS 2 (divulgaciones generales). Ambientales (E1-E5): cambio climático, contaminación, agua, biodiversidad y ecosistemas, uso de recursos y economía circular. Sociales (S1-S4): personal propio, trabajadores de la cadena de valor, comunidades afectadas, consumidores y usuarios finales. Gobernanza: G1 (conducta empresarial). Fuente: EFRAG.*
...
*Figura: un objetivo cuantificado y auditable, del tipo que la CSRD y los ESRS obligan a divulgar. La senda de descarbonización está **alineada con el Acuerdo de París (1,5 °C)** y va de **73 MtCO2eq en 2017** a **"cero emisiones" en 2040**.*

### 5.2. Responsabilidad digital del perfil técnico

De todo lo anterior se deduce con claridad la **responsabilidad digital** que asume un perfil técnico e informático:

- **Eficiencia como criterio de diseño**: "diseño de software eficiente: crear programas que consuman menos recursos y energía". Elegir arquitecturas y algoritmos sobrios, no mover datos sin necesidad y dimensionar bien la infraestructura son decisiones **éticas**, porque tienen impacto ambiental.
- **Gestión responsable del hardware**: reciclaje de RAEE, reutilización de equipos, alargar el ciclo de vida.
- **Datos veraces**: si un sistema alimenta el informe de sostenibilidad de la empresa (consumos, residuos, indicadores sociales), esos datos deben poder pasar una **verificación y auditoría**. Falsear o "maquillar" cifras es *greenwashing* y un riesgo legal.
...
La **sostenibilidad personal** se define como *"la capacidad de vivir bien hoy sin comprometer el bienestar de las personas ni los recursos del mañana"*. Y matiza dos ideas potentes:
