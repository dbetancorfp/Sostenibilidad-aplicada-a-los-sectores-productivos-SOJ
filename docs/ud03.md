...
1. [1. ODS vinculados al sector TIC y productivo](#1-ods-vinculados-al-sector-tic-y-productivo)
2. [2. Riesgos y oportunidades en la práctica profesional](#2-riesgos-y-oportunidades-en-la-practica-profesional)
3. [3. Responsabilidad individual y profesional](#3-responsabilidad-individual-y-profesional)
4. [4. Acciones sostenibles en la vida cotidiana y laboral](#4-acciones-sostenibles-en-la-vida-cotidiana-y-laboral)
5. [5. Ética y responsabilidad digital](#5-etica-y-responsabilidad-digital)
...
- **`u3_Los ODS en el desempeño profesional.pdf`** — Es el PDF más alineado con los Contenidos de la UT3. Aporta las definiciones de desempeño profesional/personal y sostenible, la relación de los ODS 9, 12 y 13 con el sector informático, los conceptos de riesgo y oportunidad con ejemplos, las listas de acciones profesionales y personales, y toda la parte de sostenibilidad empresarial (cultura de sostenibilidad, comité de sostenibilidad, ventajas).
- **`UT 3 Sostenibilidad en lo profesional y lo personal.pdf`** — Aporta el marco **IRO**, la **materialidad de impacto y financiera** (doble materialidad), la **evaluación y puntuación de los IRO** (scope, scale, irremediability, likelihood / magnitude, likelihood) y la **normativa y estándares** (CSRD, ESRS —12 estándares—, CSDDD, EFRAG, GRI), además de la definición de sostenibilidad personal. Incluye el diagrama de IRO materiales y la captura de los 12 ESRS.
- **`plan-sostenibilidad-2025-2027.pdf`** — Plan de sostenibilidad real de Endesa. Se usa como **ejemplo de aplicación**: estructura ASG y aceleradores de crecimiento (ciberseguridad, digitalización, finanzas sostenibles), 65 objetivos medibles, resultado de la doble materialidad (49 IRO materiales), principales tendencias ESG con datos (2024 como año más cálido, +1,5 °C, 6 de 9 límites biofísicos superados, −69 % de poblaciones de especies desde 1970, Paquete Ómnibus), senda de descarbonización y objetivos de ciberseguridad ligados a ODS.
- **`UNIDAD_3.pdf`** — Presentación de aula (Ediciones Paraninfo) sobre los retos sociales de la Agenda 2030. Aunque su enfoque es el de los retos sociales más que el del desempeño profesional, aporta datos para la sección de acciones frente a retos ambientales y sociales: población mundial y capacidad de carga, huella de carbono e hídrica (infografía de la hamburguesa), desperdicio alimentario en España, pobreza severa, despoblamiento rural y efecto de la educación ambiental.

### Aviso sobre solapamientos y enfoque

Los cuatro PDF se solapan de forma parcial y desigual. `u3_Los ODS en el desempeño profesional.pdf` y `UT 3 Sostenibilidad en lo profesional y lo personal.pdf` son los que responden directamente a los Contenidos de la UT3 y entre ellos encajan bien (uno aporta la parte de ODS/acciones/empresa y el otro la parte de IRO/normativa). `UNIDAD_3.pdf` trata en realidad los **retos sociales** (contenido más propio de la UT2) y aquí se ha usado solo como apoyo de datos. El **Contenido "Ética y responsabilidad digital"** está poco desarrollado como texto en los PDF: lo que sí está muy trabajado es el marco normativo europeo (CSRD, ESRS, CSDDD, EFRAG, GRI), que es la base sobre la que hoy se construye esa responsabilidad; la parte de ética de la IA, privacidad y sesgos se ha señalado como ejemplo/noticia y queda como tema abierto para ampliar en clase.
