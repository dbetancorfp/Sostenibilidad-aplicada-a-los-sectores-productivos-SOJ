...
- **`U4_Economia_Circular.pdf`** — Documento principal de la unidad. Aporta las definiciones y
  ejemplos del **modelo lineal**, la **economía verde** y la **economía circular**; el
  detalle de las **9R** con ejemplos del sector TIC; los **principios y beneficios del
  ecodiseño**; las **ecoetiquetas** (EPEAT, Energy Star, TCO Certified, etiquetado
  energético UE); las **etapas del ciclo de vida** del producto; la tabla comparativa
  lineal/circular; y los proyectos Closing the Loop, Fairphone y CEWASTE. Incluye glosario.
- **`UNIDAD_4.pdf`** — Presentación (Ediciones Paraninfo, "Sostenibilidad aplicada al sector
  productivo"). Aporta la **definición de economía**, las **cuatro etapas** del sistema
  productivo clásico, los **sectores** y los **colores de la economía**; los **5 principios
  rectores** de la economía circular; los **ciclos** lineal/circular (recursos
  biodegradables y no biodegradables); la **EEEC** y sus **objetivos a 2030**; la
  **Ley 7/2022** de residuos; la relación economía circular–desarrollo sostenible; la
  **tabla de ecodiseño por fases** (rojo/verde); la **alargascencia**; los **bioplásticos**
  (PLA, PHA, PBS); la norma **ISO 14006**; la secuencia de **I+D+i**; el **ACV según ISO
  14040** (4 etapas); y ejemplos por sectores (construcción, mobiliario urbano,
  agroalimentario/Talkual).

> **Aviso sobre contradicciones entre PDF.** La única discrepancia relevante es el nombre de
> las dos últimas "R" de las 9R: `U4_Economia_Circular.pdf` dice *Rediseñar* y *Reintegrar*;
> `UNIDAD_4.pdf` dice *Repensar* y *Refabricar*. El concepto es equivalente. En este resumen
> se ha usado la lista de `U4_Economia_Circular.pdf` por estar más desarrollada.
