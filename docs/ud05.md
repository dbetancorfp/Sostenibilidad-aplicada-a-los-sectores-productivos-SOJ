...
Esta unidad se centra en la práctica de **realizar actividades sostenibles** minimizando su impacto ambiental y social. Integra conocimientos previos —economía circular, principios de ecodiseño, identificación de riesgos y efectos ambientales— en torno a cuatro herramientas: **medir y evaluar** el impacto de una actividad; conocer su **huella** (de carbono, hídrica, ecológica y digital); aplicar **estrategias sostenibles y ecodiseño** para eliminar el impacto en origen; y cumplir la **normativa y las políticas ambientales** aplicables.

El hilo conductor es la **eliminación de impactos en origen**: evitar un problema resulta más barato y eficaz que corregirlo después. Diseñar bien un producto o servicio, elegir buenos materiales, consumir menos energía y planificar el fin de vida evita residuos y emisiones que, de otro modo, habría que tratar.
...
*Figura: la norma **ISO 14001** se utiliza para la evaluación ambiental porque aporta un proceso ordenado dentro de un **sistema de gestión ambiental (SGA)** para identificar y valorar los impactos que la organización genera en el medio. La imagen resume sus ventajas: mejora de la gestión ambiental, de los métodos de trabajo, de las condiciones laborales, control sistemático de costes, ventaja competitiva y mayor confianza de clientes y administración.*
...
Existen herramientas web oficiales y gratuitas para calcular la huella personal:

| Herramienta | Para qué sirve |
| --- | --- |
| **Global Footprint Network** (`footprintcalculator.org/home/es`) | Calcula la huella personal y cuántos "planetas" harían falta. Multilingüe, incluye español. |
...
Las estrategias sostenibles se agrupan en **cinco componentes interrelacionados**:
...
*Figura: la economía verde **previene el daño**, la economía circular **elimina los residuos desde el diseño** (rediseñar, reutilizar, reciclar…) y el **ecodiseño** actúa **en el origen**, integrando criterios ambientales desde la primera fase y apoyándose en el **análisis de ciclo de vida (ACV)**.*
...
Aunque el ejemplo de partida es industrial (juguetes robustos y reparables, embalaje compacto), los principios se trasladan casi literalmente al **diseño de productos y servicios digitales**: elegir bien la infraestructura, optimizar para que consuma menos, diseñar pensando en actualizaciones y mantenimiento en lugar de en la sustitución, y no "sobredimensionar".
...
- Una **estrategia sostenible** es integral y planificada; se divide en **economía, medio ambiente, sociedad, gobernanza e innovación/tecnología**.
...
> *Nota sobre la referencia normativa:* el real decreto de envases aparece citado como **RD 1055/2022** y, en algún índice, como **RD 1015/2022** (ambos "de 27 de diciembre, de envases y residuos de envases"). Se toma como correcta **RD 1055/2022**, que es la habitual.
...
| Fase | Qué ocurre | Criterio de sostenibilidad (ejemplos) |
| --- | --- | --- |
...
Se suele usar la **industria textil** como ejemplo (algodón orgánico, menos agua y energía, tintes respetuosos), pero la lógica es universal: **mirar cada fase y preguntarse qué se puede hacer mejor**.
...
*Figura: la RSC se representa como el punto donde se cruzan **planeta**, **personas** y **empresa**.*
...
*Figura: grupos de interés **internos** (plantilla, dirección, propiedad) y **externos** (proveedores, clientes, sociedad, gobiernos, acreedores, accionistas). Un plan de sostenibilidad moderno implica a todos ellos, no solo a un departamento.*

Elementos de un plan de sostenibilidad:
